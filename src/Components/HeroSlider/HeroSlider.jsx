                ...
                <div className="hero lg:w-[55%]">
                    <div className='hero-wrap'>
                        <div className="w-full absolute slider1">
                            <p className='block top-[150px] absolute pl-16 text-[73px] font-extrabold text-[#fa4738] hero_animate'>Travel & <span className='block mt-[-20px] text-[#fa4738] hero_stroke'>Adventure</span></p>

                            <p className='text-white pt-7 pl-16 w-5/6 absolute top-[350px] hero_details_animate'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus, mollitia animi? Ipsum ratione ullam numquam soluta aliquam quia vitae voluptatibus!
                            </p>

                            {/* button div */}
                            <div className='pl-16 mt-16 absolute top-[420px] hero_btn_animate'>
                            ...
                            hover:text-[#fa4738] duration-300'>View Adventure</button>
                                ...
                                <button type="submit" className='px-8 py-3 font-semibold border-2 border-[#fa4738] text-[#fa4738] text-[18px] hover:bg-[#fa4738] hover:text-white duration-300'>Take A Tour</button>
                        ...
                        <div className="w-full absolute slider2 ">
                            <p className='block top-[150px] absolute pl-16 text-[73px] font-extrabold text-[#fa4738] hero_animate'>Move The <span className='block mt-[-20px] text-[#fa4738] hero_stroke'>Earth</span></p>
